                    ...
                    <div class="col-md-3">
                        <div class="card card-dashboard stats-card bg-danger text-white">
                            <div class="card-body">
                                ...
                                <a href="laporan-kerusakan.php" class="text-white">Lihat laporan <i class="bi bi-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="card card-dashboard h-100">
                            <div class="card-header bg-white d-flex justify-content-between align-items-center">
                                ...
                                <a href="log-aktivitas.php" class="btn btn-sm btn-primary">Lihat Semua</a>
                            </div>
                            <div class="card-body">
